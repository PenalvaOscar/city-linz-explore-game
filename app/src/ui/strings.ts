const strings = {
  ...
  cameraPermissionMessage: 'Allow camera access so you can take a photo for this spot.',
  ...
  onTarget: 'Facing the right way',
  calibrateCompass: 'No compass reading, move your phone in a figure eight',
  captureTargetNone: 'This spot has no reference heading',
  ghostHide: 'Hide reference',
  ghostShow: 'Show reference',
